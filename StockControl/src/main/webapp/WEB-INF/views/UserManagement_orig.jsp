...
<html>
  <head>  
    <title>AngularJS $http Example orig</title>  
    <style>
      .username.ng-valid {
  ...
  <body ng-app="myApp" class="ng-cloak">
      <div ng-controller="UserController as ctrl">
          ...
          <div class="panel panel-default">
              <div class="panel-heading"><span class="lead">Clienti</span></div>
              <div class="tablecontainer">
                  <table class="table table-hover">
                      <thead>
                          <tr>
                      ...
                      <tbody>
                          <tr ng-repeat="c in ctrl.users">
                              ...
                              <td>
                              <button type="button" ng-click="ctrl.edit(c.idCliente)" class="btn btn-success custom-width">Edit</button>  <button type="button" ng-click="ctrl.remove(c.idCliente)" class="btn btn-danger custom-width">Remove</button>
                              </td>
                          </tr>
                      </tbody>
                  </table>
