...
<body ng-app="myApp" class="ng-cloak">
	...
	<div class="bar">
		<a class="list-icon" ng-class="{active: layout == 'list'}"
	...
	<ul ng-show="layout == 'grid'" class="grid">
		...
		<li ng-repeat="p in pics"><a href="{{p.link}}" target="_blank"><img
				ng-src="{{p.images.low_resolution.url}}" /></a></li>
	</ul>

	<ul ng-show="layout == 'list'" class="list">
		<!-- A compact view smaller photos and titles -->
		<li ng-repeat="p in pics"><a href="{{p.link}}" target="_blank"><img
				ng-src="{{p.images.thumbnail.url}}" /></a>
			<p>{{p.caption.text}}</p></li>
	</ul>
		...
		<div class="panel panel-default">
			...
			<div class="tablecontainer">
				<table class="table table-hover">
					...
					<tbody>
						<tr ng-repeat="c in ctrl.users">
							<td><span ng-bind="c.idCliente"></span></td>
							<td><span ng-bind="c.descrizione"></span></td>
							<td>
								<button type="button" ng-click="ctrl.edit(c.idCliente)"
									class="btn btn-success custom-width">Edit</button>
								<button type="button" ng-click="ctrl.remove(c.idCliente)"
									class="btn btn-danger custom-width">Remove</button>
							</td>
						</tr>
					</tbody>
